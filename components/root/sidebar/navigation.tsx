  ...
  const navigation = [
    ...
    },
    {
      ...
      items: [
        {
          title: "Workspaces",
          url: "/administration/workspaces",
          icon: BriefcaseBusiness,
          isActive: pathname.startsWith("/administration/workspaces"),
          isOpen: pathname.startsWith("/administration/workspaces"),
          items: [],
        },
        {
          title: "Accesses",
          url: "/administration/accesses",
          icon: UserCog,
          isActive: pathname.startsWith("/administration/accesses"),
          isOpen: pathname.startsWith("/administration/accesses"),
          items: [],
        },
      ],
    },
