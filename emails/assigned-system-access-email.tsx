...
export function AssignedSystemAccessEmailTemplate({
  userName,
  userEmail,
  assignerName,
  dashboardUrl,
        ...
        <Body className="bg-gray-100 font-sans">
          <Container className="mx-auto max-w-lg bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <Section className="p-8">
              ...
              <Text className="mb-4">
                You have been assigned system access by {assignerName}. Your
                account ({userEmail}) now has elevated permissions on the
                Backstage Dashboard.
              </Text>
              <Text className="mb-6">
              ...
              <Text className="text-sm text-gray-600">
                If you have any questions about your new permissions, please
...
export default AssignedSystemAccessEmailTemplate;
