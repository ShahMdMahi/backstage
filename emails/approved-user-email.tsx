...
export function ApprovedUserEmailTemplate({
  name,
  email,
  dashboardUrl,
}: {
        ...
        <Body className="bg-gray-100 font-sans">
          <Container className="mx-auto max-w-lg bg-white shadow-lg rounded-lg overflow-hidden">
            <Section className="bg-success text-white text-center py-8">
              <Text className="text-2xl font-bold">Account Approved!</Text>
            </Section>
            <Section className="p-8">
              <Text className="text-lg mb-4">Hi {name},</Text>
              <Text className="mb-4">
                Great news! Your account ({email}) has been approved and is now
                active.
              </Text>
              <Text className="mb-6">
                You now have full access to the Backstage Dashboard and can
                start managing your music, tracks, and analytics.
              </Text>
              <Button
...
export default ApprovedUserEmailTemplate;
